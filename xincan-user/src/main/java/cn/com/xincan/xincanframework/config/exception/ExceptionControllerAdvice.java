...
public class ExceptionControllerAdvice{
    ...
    public ResponseObject<String> businessException(BusinessException businessException) {
    ...
    public ResponseObject<String> exception(Exception exception) {
        Throwable throwable = exception.getCause();
    ...
    public ResponseObject<String> constraintViolationException(ConstraintViolationException constraintViolationException) {
    ...
    public ResponseObject<String> methodArgumentNotValidException(MethodArgumentNotValidException methodArgumentNotValidException) {
