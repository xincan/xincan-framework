...
public class ExceptionControllerAdvice extends BaseExceptionControllerAdvice {
    ...
    /**
     *  自定义业务异常
     * @param orderException 业务异常类
     * @author Jiangxincan
     * @date 2020/9/9 14:37
     * @return cn.com.xincan.xincanframework.utils.response.ResponseObject<java.lang.String>
     */
    @ExceptionHandler(OrderException.class)
    public ResponseObject<String> handlerBusinessException(OrderException orderException) {
        log(OrderException.class, ResponseCode.BUSINESS_EXCEPTION, orderException);
        return ResponseResult.error(ResponseCode.BUSINESS_EXCEPTION,  orderException.getMsg());
    }
