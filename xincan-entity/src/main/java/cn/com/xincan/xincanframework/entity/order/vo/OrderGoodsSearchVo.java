...
@AllArgsConstructor
@Builder
public class OrderGoodsSearchVo implements Serializable {

    private static final long serialVersionUID = 8090866978146132369L;

    @ApiModelProperty(name="id", value="订单ID", dataType = "String", hidden = true, example = "1285522130867376129")
    private String id;

    @ApiModelProperty(name="userId", value="用户ID", dataType = "String", example = "1285759156342562818")
